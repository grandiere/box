...
class MHelpReleaseHarvest:MHelpProtocol
{
    ...
    init()
    {
        ...
        let stringTitle:NSAttributedString = NSAttributedString(
            string:NSLocalizedString("MHelpReleaseHarvest_title", comment:""),
            attributes:attributesTitle)
        let stringDescription:NSAttributedString = NSAttributedString(
            string:NSLocalizedString("MHelpReleaseHarvest_description", comment:""),
