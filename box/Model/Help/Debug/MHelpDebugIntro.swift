...
class MHelpDebugIntro:MHelpProtocol
{
    ...
    init()
    {
        ...
        let stringTitle:NSAttributedString = NSAttributedString(
            string:NSLocalizedString("MHelpDebugIntro_title", comment:""),
            attributes:attributesTitle)
        let stringDescription:NSAttributedString = NSAttributedString(
            string:NSLocalizedString("MHelpDebugIntro_description", comment:""),
    ...
    var image:UIImage
    {
        get
        {
            return #imageLiteral(resourceName: "assetHelpDebugIntro")
        }
    }
}
