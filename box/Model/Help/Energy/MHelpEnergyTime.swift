...
class MHelpEnergyTime:MHelpProtocol
{
    ...
    init()
    {
        ...
        let stringTitle:NSAttributedString = NSAttributedString(
            string:NSLocalizedString("MHelpEnergyTime_title", comment:""),
            attributes:attributesTitle)
        let stringDescription:NSAttributedString = NSAttributedString(
            string:NSLocalizedString("MHelpEnergyTime_description", comment:""),
    ...
    var image:UIImage
    {
        get
        {
            return #imageLiteral(resourceName: "assetHelpEnergyTime")
        }
    }
}
