...
class MHelpAntivirusIntro:MHelpProtocol
{
    ...
    init()
    {
        ...
        let stringTitle:NSAttributedString = NSAttributedString(
            string:NSLocalizedString("MHelpAntivirusIntro_title", comment:""),
            attributes:attributesTitle)
        let stringDescription:NSAttributedString = NSAttributedString(
            string:NSLocalizedString("MHelpAntivirusIntro_description", comment:""),
    ...
    var image:UIImage
    {
        get
        {
            return #imageLiteral(resourceName: "assetHelpAntivirusIntro")
        }
    }
}
