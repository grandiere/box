...
class MHelpAntivirusStats:MHelpProtocol
{
    ...
    init()
    {
        ...
        let stringTitle:NSAttributedString = NSAttributedString(
            string:NSLocalizedString("MHelpAntivirusStats_title", comment:""),
            attributes:attributesTitle)
        let stringDescription:NSAttributedString = NSAttributedString(
            string:NSLocalizedString("MHelpAntivirusStats_description", comment:""),
    ...
    var image:UIImage
    {
        get
        {
            return #imageLiteral(resourceName: "assetHelpDebugStats")
        }
    }
}
